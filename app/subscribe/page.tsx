    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-16">
        <div className="w-full max-w-lg">
          ...
          {/* Price */}
          <p className="font-mono font-black text-7xl leading-none mb-1">$5</p>
          <p className="font-mono text-sm text-[#6B6B6B] mb-8">per month · billed monthly</p>

          {/* Trial callout */}
          <div className="bg-[#0A0A0A] text-white px-6 py-5 mb-8">
          ...
          {/* Feature list */}
          <div className="border border-[#E5E5E5] divide-y divide-[#E5E5E5] mb-8">
            {[
              ...
              <div key={f} className="flex items-start gap-3 px-4 py-3">
                <span className="font-mono font-black text-[#E8FF00] bg-[#0A0A0A] px-1 text-xs mt-0.5 shrink-0">✓</span>
